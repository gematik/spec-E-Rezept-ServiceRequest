...
Instance: INVALID-prescription-request-3-1-of-2
InstanceOf: ERPServiceRequestPrescriptionRequest
Usage: #example
Title: "Invalid Prescription Request 5"
* identifier[requestId].value = "INVALID-prescription-request-3-1-of-2"
...
Instance: INVALID-prescription-request-3-2-of-2
InstanceOf: ERPServiceRequestPrescriptionRequest
Usage: #example
Title: "Invalid Prescription Request 5"
* identifier[requestId].value = "INVALID-prescription-request-3-2-of-2"
* requisition.value = "GroupID-UC3"
* basedOn = Reference(Example-Initial-Medication-Request)
