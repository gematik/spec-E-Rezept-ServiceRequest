ValueSet: GEM_VS_MEDREQ_MedicationRequest_Reason
Id: GEM-VS-MEDREQ-MedicationRequest-Reason
Title: "Grund der Medikamentenanfrage (VS)"
Description: "Liefert Codes für Gründe, warum Medikation angefragt wird"
* insert MetaValueSet(GEM-VS-MEDREQ-MedicationRequest-Reason)
...
ValueSet: GEM_VS_MEDREQ_MedicationObservation
Id: GEM-VS-MEDREQ-MedicationObservation
Title: "Angabe zur Medikamentenbeobachtung (VS)"
Description: "Gibt Arten der Beobachtungen zum Status eines Medikaments an"
* insert MetaValueSet(GEM-VS-MEDREQ-MedicationObservation)
