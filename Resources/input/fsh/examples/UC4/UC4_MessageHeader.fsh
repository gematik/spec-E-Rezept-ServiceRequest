...
* eventCoding = $GEM_CS_KIM_Dienstkennung#eRezept_ParenteraleErnaehrung;Rezeptanfrage
...
* eventCoding = $GEM_CS_KIM_Dienstkennung#eRezept_ParenteraleErnaehrung;Rezeptbestaetigung