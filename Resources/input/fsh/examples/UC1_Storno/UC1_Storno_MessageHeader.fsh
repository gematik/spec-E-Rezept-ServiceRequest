...
* eventCoding = $GEM_CS_KIM_Dienstkennung#eRezept_Rezeptanforderung;Rezeptanfrage_Storno
...
* eventCoding = $GEM_CS_KIM_Dienstkennung#eRezept_Rezeptanforderung;Abgabeanfrage_Storno
